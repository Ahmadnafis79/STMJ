          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <select name="level" id="level" class="form-control" name="level" required>
                ...
                <option value="UT" <?php if ($l == 'ut') echo 'selected'; ?>>UT
                </option>
                <option value="UTSchool" <?php if ($l == 'UTSchool') echo 'selected'; ?>>UTSchool</option>
                <option value="Customer" <?php if ($l == 'Customer') echo 'selected'; ?>>Customer</option>
                <option value="Admin" <?php if ($l == 'Admin') echo 'selected'; ?>>Admin</option>
              </select>
            </div>
